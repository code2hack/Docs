...
\includepdf[link=true,pages=-,fitpaper]{./papers/NEAR-DATA-PROCESSING-FOR-MACHINE-LEARNING.pdf}
\includepdf[link=true,pages=-,fitpaper]{./papers/Practical-Near-Data-Processing-for-In-memory-Analytics-Frameworks.pdf}
\includepdf[link=true,pages=-,fitpaper]{./papers/Practical-Near-Data-Processing-for-In-memory-Analytics-Frameworks(Presentation).pdf}
