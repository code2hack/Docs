...
\author{\IEEEauthorblockN{1\textsuperscript{st} Hui Chen}
\IEEEauthorblockA{\textit{National University of Defense Technology} \\
Changsha, China\\
code2hack4ever@gmail.com}
\and
\IEEEauthorblockN{2\textsuperscript{th} Enqiang Zhou*}
\IEEEauthorblockA{\textit{National University of Defense Technology} \\
...
\begin{figure}
\centering
\includegraphics[width=0.3\textwidth]{images/GRU}
